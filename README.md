...
In addition to the [godoc API documentation](http://godoc.org/github.com/x5iu/sqlx),
...
[sqlx_test.go](https://github.com/x5iu/sqlx/blob/master/sqlx_test.go) for more
usage.
